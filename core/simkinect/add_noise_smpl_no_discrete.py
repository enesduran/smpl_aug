...
from simkinect.camera_utils import filterDisp, add_gaussian_shifts
...
def mesh2pcd(vertices, 
    ...
    # out_disp = filterDisp_batch(depth_f, kinect_dot_pattern, INVALID_DISP_THRESHOLD, filter_size_window)
