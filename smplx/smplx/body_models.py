...
class SMPL(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if clothing_option != 'minimal':
            print('Using the clothed SMPL model, initializing the SCULPT model. This may take a while.')
            ...
            self.sculpt_instance = SCULPT(geo_network_pkl_path=SCULPT_GEO_MODEL_PATH,
                                    ...
                                    outdir = './outdir')           
            print('SCULPT model loaded.')

        self.render_depth = render_depth
        
        if render_depth:
            print('Setting up the renderer')
    ...
    def forward(
        ...
        **kwargs
        ...
        if self.render_depth and kwargs.get("camera") is not None:
