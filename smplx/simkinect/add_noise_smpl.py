...
if __name__ == "__main__":
    ...
    ###
    image_path = '/Users/yunhanwang/Desktop/DepthCapture_2024-05-08-21-19-05.png'
    noised_image_name = 'noised_smpl.png'
    ###

    depth_uint16 = cv2.imread(image_path, cv2.IMREAD_UNCHANGED) 
    h, w = depth_uint16.shape 

    # Our depth images were scaled by 5000 to store in png format so dividing to get 
    # depth in meters 
    depth = depth_uint16.astype('float') / depth_scale
    ...
    noisy_depth = noisy_depth * depth_scale 
    noisy_depth = noisy_depth.astype('uint16')

    cv2.imwrite(noised_image_name, noisy_depth)
